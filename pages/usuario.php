...
if (isset($_POST['accion'])) {
    if ($_POST['accion'] === 'iniciar' && isset($_POST['id_proyecto'])) {
        ...
        // LOG: Inicio de fichaje
        escribirLog("Usuario {$_SESSION['correo']} inició fichaje en proyecto {$proyecto['nombre']}", "INFO");
        ...
        // LOG: Fin de fichaje
        escribirLog("Usuario {$_SESSION['correo']} terminó fichaje en proyecto {$_COOKIE['proyecto_nombre']} ({$horas}h)", "INFO");
    ...
    <form method="POST">
        ...
        <?php else: ?>
            <div class="status-box">
                <p><i class="fa-solid fa-rocket"></i>Trabajando en:<br><?php echo htmlspecialchars($_COOKIE['proyecto_nombre'] ?? 'Proyecto') ?></p>
